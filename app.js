...
const translations = {
  // GENERAL
  appName: { en: "Digiwizr Sales Tracker", bn: "Digiwizr সেলস ট্র্যাকার" },
  ...
  // SIGNUP PAGE
  welcomeTitle: { en: "Welcome to Digiwizr Sales Tracker", bn: "Digiwizr সেলস ট্র্যাকার-এ স্বাগতম" },
  welcomeSubtitle: { en: "Please set up your account to get started.", bn: "শুরু করতে আপনার অ্যাকাউন্ট সেটআপ করুন।" },
  ...
  setupAccount: { en: "Set Up Account", bn: "অ্যাকাউন্ট সেটআপ করুন" },
  alreadyHaveAccount: { en: "Already have an account? Enter your PIN to unlock.", bn: "ইতিমধ্যেই একটি অ্যাকাউন্ট আছে? আনলক করতে আপনার পিন প্রবেশ করান।" },
  pinMustBe4Digits: { en: "PIN must be exactly 4 digits.", bn: "পিন অবশ্যই ঠিক ৪ সংখ্যার হতে হবে।" },
  setupSuccessful: { en: "Setup successful! Please save your Recovery PIN.", bn: "সেটআপ সফল হয়েছে! অনুগ্রহ করে আপনার পুনরুদ্ধার পিন সংরক্ষণ করুন।" },
  recoveryPinLabel: { en: "Recovery PIN (6 digits)", bn: "পুনরুদ্ধার পিন (৬ সংখ্যা)" },
  recoveryPinInstructions: { en: "This Recovery PIN can be used to recover your account if you forget your access PIN. Please save it securely.", bn: "আপনার অ্যাক্সেস পিন ভুলে গেলে এই পুনরুদ্ধার পিন ব্যবহার করে আপনার অ্যাকাউন্ট পুনরুদ্ধার করা যাবে। অনুগ্রহ করে এটি নিরাপদে সংরক্ষণ করুন।" },
  saveRecoveryPin: { en: "Save Recovery PIN", bn: "পুনরুদ্ধার পিন সংরক্ষণ করুন" },
  
  // PIN ENTRY PAGE
  enterPin: { en: "Enter PIN", bn: "পিন প্রবেশ করান" },
  ...
  //RECOVERY PAGE
  recoverAccount: { en: "Recover Account", bn: "অ্যাকাউন্ট পুনরুদ্ধার করুন" },
  enterRecoveryPin: { en: "Enter your 6-digit Recovery PIN", bn: "আপনার ৬-সংখ্যার পুনরুদ্ধার পিন প্রবেশ করান" },
  recoverButton: { en: "Recover Account", bn: "অ্যাকাউন্ট পুনরুদ্ধার করুন" },
  recoveryFailed: { en: "Recovery PIN not found. Please check and try again.", bn: "পুনরুদ্ধার পিন পাওয়া যায়নি। অনুগ্রহ করে পরীক্ষা করুন এবং আবার চেষ্টা করুন।" },
  newPin: { en: "Set a New 4-digit PIN", bn: "নতুন ৪-সংখ্যার পিন সেট করুন" },
  confirmNewPin: { en: "Confirm New PIN", bn: "নতুন পিন নিশ্চিত করুন" },
  setNewPinButton: { en: "Set New PIN", bn: "নতুন পিন সেট করুন" },
...
function renderReportSummary(summary) {
  ...
  $("reportSummaryBody").innerHTML = `
    ...
    <div class="report-summary-row"><span>${t("profitPercentage")}</span><span class="value ${profitPctClass}">${profitPercentage.toFixed(1)}%</span></div>
  `;
}
